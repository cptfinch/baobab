      ...
      module CompositeInstanceMethods  
        ...
        def quoted_id #:nodoc:
          [self.class.primary_keys, ids].
            transpose.
            map {|attr_name,id| safe_quote_value(id, column_for_attribute(attr_name))}.
            to_composite_ids
        end
...
module ActiveRecord
  ...
  class Base
    ...
    def safe_quote_value(id, column)
      self.methods.include?('quote_value') ? quote_value(id, column) : quote(id, column)
    end    
  end
end
