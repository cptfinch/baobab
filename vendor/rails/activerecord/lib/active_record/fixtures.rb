...
class Fixtures < YAML::Omap
  ...
  attr_reader :fixture_table_name
        ...
        def load_fixtures
          ...
          unless fixtures.nil?
            if fixtures.instance_of?(Fixtures)
              @loaded_fixtures[fixtures.fixture_table_name] = fixtures
            else
              fixtures.each { |f| @loaded_fixtures[f.fixture_table_name] = f }
            end
          end
        end
