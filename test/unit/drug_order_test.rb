...
class DrugOrderTest < Test::Unit::TestCase
  ...
  def test_should_return_given_dosage
    ...
    assert_equal ["Stavudine 30 Lamivudine 150 Nevirapine 200,Morning,1", "Stavudine 30 Lamivudine 150 Nevirapine 200,Evening,1"], DrugOrder.given_drugs_dosage(drug_orders)  
  end  
